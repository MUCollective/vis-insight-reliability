...
tibble(alpha = seq(from = 0.01, to = 0.3, length.out = 20),
  ...
  ggplot(aes(alpha, K)) + 
  geom_contour_filled(aes(z = 1- Fp))  +
  labs(title = "alpha and beta")
```
...
rates_df %>%
  ...
  labs(title = "Simulated and theoretical payouts using different strategies")
```
