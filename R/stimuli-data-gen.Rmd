...
for(i in 1:ntrials) {
    ...
    ggsave(filename = paste0('../plots/raw-data/profits-', i, '.png'), height = 18, width = 9, units = "in", dpi = 72, plot = p, device = "png")
}
```
...
for(i in 1:ntrials) {
    ...
    ggsave(filename = paste0('../plots/mean-ci/profits-', i, '.png'), height = 18, width = 9, units = "in", dpi = 72, plot = p, device = "png")
}
```
